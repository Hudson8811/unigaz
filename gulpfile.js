...
let /** @type {import("imagemin-mozjpeg")} */ imageminMozjpeg;
let /** @type {import("imagemin-optipng").default} */ imageminOptipng;
...
gulp.task('default', gulp.series('startup', 'build','webwatch'));
